...
public class LocalCommand extends AbstractErrorCommand implements Command {
    ...
    public CommandResult execute(RequestContext requestContext) throws ServiceException {
        ...
        String address = requestContext.getRequestParameter(ADDRESS_PARAMETER)[INDEX_FIRST_VALUE];
        return CommandResult.redirect(address);
    }
